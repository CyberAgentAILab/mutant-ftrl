...
PSEUDO_BANDIT_FEEDBACK = 'pseudo_bandit'

def run_ftrl(p_id, game, agents, n_iterations, logger, feedback = FULL_FEEDBACK, random_policy = False):
    trajectories = [[] for agent in agents]
    time_average_trajectories = [[] for agent in agents]
    exploitabilities = []
