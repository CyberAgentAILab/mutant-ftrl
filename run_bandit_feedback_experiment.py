...
parser.add_argument('--arch', type=str, default=MFTRL,  choices=FTRLS)
...
if __name__ == "__main__":
    ...
    args.dir_name = 'arch_{}_{}_feedback_{}_{}'.format(args.arch, payoff, ftrl.BANDIT_FEEDBACK, args.dir_suffix)
